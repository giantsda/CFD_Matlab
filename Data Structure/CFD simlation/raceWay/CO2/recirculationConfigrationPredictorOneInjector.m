...
SSPH=8;
SStotalC=10/1000;%mmol/L to mol/L;
...
for i=1:length(flowRateArray)
    ...
    H=(SSH*flowRate+addProton)/flowRate;
    OH=SSOH;
    %% water ionization step
    a=1;
    b=H+OH;
    c=H*OH-Kw;
    ...
    OH=OH+x;
    inletPH=-log10(H);
    inletTotalC=(SStotalC*flowRate+addTotalC)/flowRate;
