...
Torque_sum(i,9)=Torque_sum(i,1)+Torque_sum(i,3)+Torque_sum(i,5)+Torque_sum(i,7)-Torque_sum(i,2)-Torque_sum(i,4)-Torque_sum(i,6)-Torque_sum(i,8);
end
ttime=time_i(:,2);
figure;
plot(Torque_sum(:,9));