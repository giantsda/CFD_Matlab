...
size_connected_particle=size(connected_particle);
size_connected_particle=size_connected_particle(1);
connected_particle(:,2)=[0:0.0015:0.0015*(size_connected_particle-1)];


%%
xq=[1:1:1.335558465000000e+05];
haha = interp1(connected_particle(:,2),connected_particle(:,1),xq,'spline');
haha(2,:)=xq;
haha=haha.';
% load ('connected_particle.mat');
csvwrite('connected_particle.csv',haha)
