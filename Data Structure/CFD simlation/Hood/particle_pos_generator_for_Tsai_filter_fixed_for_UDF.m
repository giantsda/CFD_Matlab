...
particle_number=19500; % define the particle number
% x=0  % for case 7
% y=0
% z=300/1000

x=0.070575  % for case 11
y=0.05 
z=0
...
elememt_len=(xlengh*1*zlengh/particle_number)^(1/2);
...
load('r_sample.mat');
X=X/1000000; % convert to m
d=X(1:elen_x*elen_y*elen_z+2).';
mass=4/3*pi*(d./2).^3*3600; % calculate the mass, 1000 is the density. 
